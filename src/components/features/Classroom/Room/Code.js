  ...
  return (
    <>
      <div className={classes.btn}>
        <Button variant="contained" color="primary" size="small" fullWidth style={{ marginTop: 17 }} onClick={handleClickOpen}>
          Code
        </Button>
      </div>
      <Dialog fullScreen open={open} onClose={handleClose} TransitionComponent={Transition}>
        ...
        <div className={classes.root} style={{ backgroundColor: state.isDarkMode ? '#353535' : '#f0f2f5' }}>
          <div className={classes.description}>
            <div className={classes.descriptionTool} style={{ width: drawerWidth }}>
            ...
            <div onMouseDown={(e) => handleMouseDown(e)} className={classes.draggerWidth}>
              <IconButton
                size="small"
                className={classes.draggerWidthIcon}
                style={{ backgroundColor: state.isDarkMode ? '#353535' : '#D8DADF' }}
              >
                <CodeIcon />
              </IconButton>
            </div>
          ...
          <Paper className={classes.code}>
            <div className={classes.option}>
              ...
              <select
                ...
                onChange={e => {
                  ...
                  if (sel.value == 'c') {
                    setRunData({
                      ...runData, language: 'c', compiler: 'g++'
                    })
                  } else if (sel.value == 'python') {
                    setRunData({
                      ...runData, language: 'py', compiler: 'python'
                    })
                  }
                  console.log(runData);
                }}
                      ...
                      (item.type == "success") ? (
                        <>
                          ...
                          <>
                            ...
                            <br />
                            <br />
                            <strong>Error:</strong><span style={{ color: '#ef7676' }}> {item.output}</span>
                          </>
                        )
                    ))}
                  </div>
            ...
            >
              <textarea
                ...
                onChange={e => setRunData({ ...runData, input: e.target.value })}
